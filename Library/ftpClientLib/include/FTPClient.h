...
namespace nsFTP
{
   ...
   /// - ...
   ///
   class FTPCLIENTLIB_EXPORT CFTPClient
   {
   public:
      class CNotification;
      ...
      CFTPClient(std::auto_ptr<IBlockingSocket> apSocket=nsSocket::CreateDefaultBlockingSocketInstance(),
                 unsigned int uiTimeout=100, unsigned int uiBufferSize=2048, 
	  ...
	  bool List(const tstring& strPath, TFTPFileStatusShPtrStack& vFileList, bool fPasv = false) const;
...
// data members
   ...
   class FTPCLIENTLIB_EXPORT CFTPClient::CNotification : public nsHelper::CObserverPatternBase<CFTPClient::TObserverSet*, CFTPClient::CNotification*>
   {
   public:
   ...
   class FTPCLIENTLIB_EXPORT CFTPClient::ITransferNotification : public IInterface
   {
   public:
   ...
   class FTPCLIENTLIB_EXPORT CFTPClient::IFileListParser : public IInterface
   {
   public:
   ...
   class FTPCLIENTLIB_EXPORT COutputStream : public CFTPClient::ITransferNotification
   {
      class CPimpl;
