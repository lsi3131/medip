...
class ActionCTQuantization : public QUndoCommand
{
public:
	ActionCTQuantization(VOLUME_DATA* pVolumeData, const std::vector<mint16>& output_Data, float alpha, QUndoCommand* parent = NULL);
	~ActionCTQuantization();
