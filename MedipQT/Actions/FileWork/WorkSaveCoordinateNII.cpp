#include "stdafx.h"
#include "WorkSaveCoordinateNII.h"

WorkSaveCoordinateNII::WorkSaveCoordinateNII(VOLUME_DATA* pVolumeData, mask _m, int _mI, const QString& strFileName)
{
...
void WorkSaveCoordinateNII::threadRun()
{
...
void WorkSaveCoordinateNII::setProgressValue(int value, bool init)
{
	static int val = 0;
