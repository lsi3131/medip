...
#define USD_IMPORT
#define AI_IMAGE_ENHANCEMENT /* 전시회 때만 적용할 것 */
#else
...
//#define SUPPORT_HEART_SOLUTION //220406 허 건 과장 심장솔루션

#define SUPPORT_STAMP3D 0
#define SUPPORT_MESHOFFSET 0
#define SUPPORT_MATCAP 0
//#define SUPPORT_3D_INTERPOLATION 1

#define USE_PRODUCT_MEDIP 0
#define USE_PRODUCT_DEEPCATCH 1
#define USE_ALPHA_VERSION 1
#define USE_BETA_VERSION 1
