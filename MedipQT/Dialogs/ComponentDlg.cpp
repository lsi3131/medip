...
ComponentDlg::ComponentDlg(QWidget* parent)
	: QDialog(parent)
{
	...
	connect(pBtnOk, &QPushButton::clicked, this, &ComponentDlg::OnOk);
	...
	connect(pBtnCancel, &QPushButton::clicked, this, &ComponentDlg::OnCancel);
...
int ComponentDlg::getClusterNum(void)
{
	return m_nClusterNum;
}

void ComponentDlg::OnOk(void)
{
	m_nClusterNum = m_LineEditNumber->text().toInt();

	done(QDialog::Accepted);
}

void ComponentDlg::OnCancel(void)
{
