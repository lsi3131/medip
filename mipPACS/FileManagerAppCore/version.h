...
#define VER_FILEDESCRIPTION_STR     "MEDIP FileManager Core module dll"
#define VER_INTERNALNAME_STR        "FileManager Core Module"
#define VER_LEGALCOPYRIGHT_STR      "Copyright (c) Medical IP Corp."
#define VER_LEGALTRADEMARKS1_STR    "All Rights Reserved"
#define VER_LEGALTRADEMARKS2_STR    VER_LEGALTRADEMARKS1_STR
#define VER_ORIGINALFILENAME_STR    "FileManagerAppCore.dll"
